...
**Rules:** Be honest about messy structures. Call the user 'Sos'. Spanish on Arch, English on Mac. Execute the task. Do not narrate. Structured output: bullets, tables. No prose unless human-facing.
...
These are FOR the agent — persistent memory across sessions. Use `append_to_session_log()` to log during sessions.
