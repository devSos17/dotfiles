...
- `racker` or `todo` defines what to build → you **build it**
- `review` checks your output → you **iterate on feedback**
- `arch` validates the approach → you **follow architectural guidance**
- `doc` documents what you did → you **provide clear commit messages**
